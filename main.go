...
// ================================================
// FUNGSI BANTUAN: ANTI-SPAM & BLACKLIST
// ================================================

// isAllowedText: Senarai putih mesej teks yang diterima
...
// CheckSpam: Dummy function (anda boleh tambah logik sebenar)
func CheckSpam(userID int64) bool {
    // TODO: Tambah logik spam detection
    return false
}

// ExecuteAutoBan: Dummy function
func ExecuteAutoBan(bot *tgbotapi.BotAPI, chatID, userID int64, username string) {
    // TODO: Logik ban automatik
    log.Printf("User %d (%s) dikesan spam, tapi auto-ban belum diaktifkan.", userID, username)
}

// IsBanned: Dummy function (anda boleh integrate dengan GitHub)
func IsBanned(userID int64) bool {
    // TODO: Semak blacklist
    return false
}

// HasAgreed: Dummy function
func HasAgreed(userID int64) bool {
    // TODO: Semak jika user sudah setuju T&C
    return true // Sementara: semua user dianggap setuju
}

// IsAdmin: Cek admin (anda boleh tambah ID admin sebenar)
func IsAdmin(userID int64) bool {
    admins := map[int64]bool{
        12345678: true, // Ganti dengan ID admin sebenar
    }
    return admins[userID]
}

// SaveAgreementToGithub: Dummy
func SaveAgreementToGithub(userID int64, username string) error {
    log.Printf("User %d (%s) setuju T&C (disimulasi)", userID, username)
    return nil
}

// BanUser: Dummy
func BanUser(userID int64, reason string) error {
    log.Printf("User %d diban: %s", userID, reason)
    return nil
}

// BuildTermsUI: Dummy
func BuildTermsUI() (string, error) {
    return "📜 *Terma & Syarat*\n\nSila baca dan setuju.", nil
}

// ================================================
// FUNGSI BANTUAN: LOAD & SEND GUIDE
// ================================================
...
func main() {
    ...
    // --- SETUP SERVER HTTP UNTUK HEALTH CHECK ---
    go func() {
        port := os.Getenv("PORT")
        if port == "" {
            port = "8080"
