...
// Backslash (\) dan tanda seru (!) juga perlu di-escape.
// Versi ini menggunakan strings.ReplaceAll untuk kawalan penuh dan mengelakkan isu regexp.
func escapeMarkdownV2(text string) string {
	...
	// 12. Escape plus (+)
	text = strings.ReplaceAll(text, `+`, `\+`)
	// 13. Escape minus (-) - Biasanya tidak menyebabkan masalah melainkan dalam senarai
	// text = strings.ReplaceAll(text, `-`, `\-`)
	// 14. Escape equals (=)
	text = strings.ReplaceAll(text, `=`, `\=`)
	// 15. Escape pipe (|)
	...
	// 18. Escape dot (.)
	text = strings.ReplaceAll(text, `.`, `\.`)
	// 19. Escape exclamation mark (!) - Penyebab ralat sebelumnya
	text = strings.ReplaceAll(text, `!`, `\!`)
